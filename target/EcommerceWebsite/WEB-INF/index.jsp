  ...
  <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
	...
	<div class="section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <iframe width="560" height="315" src="images/movie.mp4" type="video/mp4" frameborder="0" allowfullscreen=""></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-4">
      <div class="img-circle">
        <a href="#">
          <img src="images/s1.jpg" class="img-circle" alt="Pulpit Rock" height='300' width='300'>
        </a>
      </div>
      <div class="caption">
          <p>The Fox</p>
    ...
    <div class="col-md-4">
      <div class="img-circle">
        <a href="#">
          <img src="images/s2.jpg" class="img-circle" alt="Moustiers Sainte Marie" height='300' width='300'>
        </a>
      </div>
      <div class="caption">
          <p>The Scorpion</p>
    ...
    <div class="col-md-4">
      <div class="img-circle">
        <a href="#">
          <img src="images/s3.jpg" class="img-circle" alt="Cinque Terre" height='300' width='300'>
        </a>
      </div>
      <div class="caption">
          <p>The Racoon</p>
